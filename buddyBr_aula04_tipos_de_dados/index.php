...
$array_simples = ["Adriana", 1980];
$array_associativo = ["nome" => "Adriana", "ano de nascimento" => 1980];

$objeto = new Pessoa('Dayana', 'Souza', 1986);
//Funções úteis de string
$nome = 'Dayana';
$profissao = 'Estagiária de Desenvolvimento Web';

$nome = "Meu nome é $nome e sou {2+2}s";
...
<table class="tipos">
    ...
    <tr>
        ...
        <td><?php echo $interger; ?></td>
        <td></td>
        <td><?php var_dump($interger); ?></td>
    </tr>
    <tr>
        <td>Float</td>
        ...
        <td></td>
        <td><?php var_dump($float); echo '<br>'; var_dump($float2); ?></td>
    </tr>
    <tr>
        <td>String</td>
    ...
    <tr>
        ...
        <td>Booleanos podem ser: true ou false e 1 (true) ou 0 (false)</td>
